...
DEFAULT_DATA = {
    ...
    "현장대리인": "곽재운",
    "작업의 시작시간": "08:00",
    "작업 또는 작업장 간의 연락방법": "관리자 간 비상연락망(단톡방) 운영 및 휴대전화 상시 대기",
    "재해발생 위험시의 대피방법": "작업 중지 후 비상연락망 전파 및 집결지 대피",
    "사업자와 수급인 또는 수급인 상호간의 연락방법": "가스공사, 시공사, 서울검사 간 안전관리자 핫라인(단톡방) 운영",
    "작업공정의 조정 및 협의 요청사항": "일일/주간 공정회의를 통해 타 공정 간섭구간 작업 전 사전 조율",
