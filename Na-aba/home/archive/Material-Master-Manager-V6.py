...
class MaterialManager:
    ...
    def setup_daily_usage_tab(self):
        ...
        columns = ('날짜', '현장', '작업자1', '작업자2', '작업자3', '작업자4', '작업자5', '작업자6', '장비명', '검사방법', '검사량', '필름매수', '단가', '출장비', '일식', '검사비', '품목명', '센터미스', '농도', '마킹미스', '필름마크', '취급부주의', '고객불만', '기타', 'RT총계', '형광자분', '흑색자분', '백색페인트', '침투제', '세척제', '현상제', '형광침투제', '비고', '입력시간')
    ...
    def update_daily_usage_view(self):
        ...
        if not filtered_df.empty:
            ...
            mandatory_cols = ['날짜', '현장', '작업자1', '작업자2', '작업자3', '작업자4', '작업자5', '작업자6', '장비명', '검사방법', '품목명', '비고', '입력시간']
            ...
            # If empty, show mandatory columns including all workers
            all_workers_cols = ['작업자1', '작업자2', '작업자3', '작업자4', '작업자5', '작업자6']
            self.daily_usage_tree['displaycolumns'] = ['날짜', '현장'] + all_workers_cols + ['장비명', '검사방법', '품목명', '비고', '입력시간']
