...
class MaterialManager:
    def __init__(self, root):
        ...
        # Determine base directory for portability
        ...
        self.db_path = os.path.join(self.base_dir, 'Material_Inventory.xlsx')
        self.config_path = os.path.join(self.base_dir, 'Material_Manager_Config.json')
