...
output_path = r"C:\Users\-\OneDrive\바탕 화면\4.4.1_위험성평가표(UT)_최종.xlsx"
...
# --- Data Definition (UT specifically mapped from screenshots) ---
data = [
    # 1. 사전준비
    ...
    # 3. 작업후 정리
    ["작업후\n정리", "기계적(설비)적\n요인", "중량물 줄걸이작업 부적합 시 낙하에 의한 사고위험", "안전모, 안전화 착용 / 작업 전 점검", 2, 2, "V", "1. 탐상 장비 반출 시에도 2줄 걸이 이상 결속 원칙 준수\n2. 인양물 하부 접근 절대 금지"],
