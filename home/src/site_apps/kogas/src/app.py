...
from site_apps.kogas.src.daily_work_report_manager import DailyWorkReportManager
from site_apps.kogas.src.ndt_billing_kogas_tab import NDTCalculatorTab
from site_apps.kogas.src.kogas_daily_work_log_tab import KogasDailyWorkLogTab
import site_apps.kogas.src.daily_work_report_manager as daily_work_report_manager
...
class MaterialManager:
    def __init__(self, root):
        ...
        self.data_dir = os.path.join(appdata_dir, 'PMI_Apps', 'Kogas')
        os.makedirs(self.data_dir, exist_ok=True)
        
        self.config_path = os.path.join(self.data_dir, 'Kogas_Material_Manager_Config.json')
    ...
    def _on_daily_usage_sash_changed(self, *args, **kwargs):
        from site_apps.kogas.src.controllers.event_controller import _on_daily_usage_sash_changed_impl
    ...
    def _sync_dataframe_schema(self, *args, **kwargs):
        from site_apps.kogas.src.models.material_model import _sync_dataframe_schema_impl
        return _sync_dataframe_schema_impl(self, *args, **kwargs)

    def load_data(self, *args, **kwargs):
        if "export" in "load_data" or "excel" in "load_data":
            from site_apps.kogas.src.services.excel_exporter import load_data_impl
        else:
            from site_apps.kogas.src.services.data_loader import load_data_impl
    ...
    def clean_nan(self, *args, **kwargs):
        from site_apps.kogas.src.utils.helpers import clean_nan_impl
    ...
    def save_data(self, *args, **kwargs):
        if "export" in "save_data" or "excel" in "save_data":
            from site_apps.kogas.src.services.excel_exporter import save_data_impl
        else:
            from site_apps.kogas.src.services.data_loader import save_data_impl
        return save_data_impl(self, *args, **kwargs)
            
    def get_base_salaries(self, *args, **kwargs):
        from site_apps.kogas.src.models.worker_model import get_base_salaries_impl
        return get_base_salaries_impl(self, *args, **kwargs)

    def get_material_defaults(self, *args, **kwargs):
        from site_apps.kogas.src.models.material_model import get_material_defaults_impl
    ...
    def setup_stock_tab(self, *args, **kwargs):
        from site_apps.kogas.src.views.stock_management_view import setup_stock_tab_impl
    ...
    def calculate_current_stock(self, *args, **kwargs):
        from site_apps.kogas.src.models.material_model import calculate_current_stock_impl
        return calculate_current_stock_impl(self, *args, **kwargs)

    def update_stock_view(self, *args, **kwargs):
        from site_apps.kogas.src.views.stock_management_view import update_stock_view_impl
    ...
    def on_material_selected(self, *args, **kwargs):
        from site_apps.kogas.src.controllers.event_controller import on_material_selected_impl
        return on_material_selected_impl(self, *args, **kwargs)

    def _on_trans_site_return(self, *args, **kwargs):
        from site_apps.kogas.src.controllers.event_controller import _on_trans_site_return_impl
        return _on_trans_site_return_impl(self, *args, **kwargs)

    def _on_warehouse_return(self, *args, **kwargs):
        from site_apps.kogas.src.controllers.event_controller import _on_warehouse_return_impl
        return _on_warehouse_return_impl(self, *args, **kwargs)

    def _on_user_return(self, *args, **kwargs):
        from site_apps.kogas.src.controllers.event_controller import _on_user_return_impl
        return _on_user_return_impl(self, *args, **kwargs)


    def format_worker_summary(self, *args, **kwargs):
        from site_apps.kogas.src.models.worker_model import format_worker_summary_impl
    ...
    def save_df_to_excel_autofit(self, *args, **kwargs):
        if "export" in "save_df_to_excel_autofit" or "excel" in "save_df_to_excel_autofit":
            from site_apps.kogas.src.services.excel_exporter import save_df_to_excel_autofit_impl
        else:
            from site_apps.kogas.src.services.data_loader import save_df_to_excel_autofit_impl
    ...
    def export_materials(self, *args, **kwargs):
        if "export" in "export_materials" or "excel" in "export_materials":
            from site_apps.kogas.src.services.excel_exporter import export_materials_impl
        else:
            from site_apps.kogas.src.services.data_loader import export_materials_impl
    ...
    def setup_monthly_usage_tab(self, *args, **kwargs):
        from site_apps.kogas.src.views.monthly_usage_view import setup_monthly_usage_tab_impl
        return setup_monthly_usage_tab_impl(self, *args, **kwargs)
    
    def update_monthly_usage_view(self, *args, **kwargs):
        from site_apps.kogas.src.views.monthly_usage_view import update_monthly_usage_view_impl
        return update_monthly_usage_view_impl(self, *args, **kwargs)

    def on_monthly_usage_select(self, *args, **kwargs):
        from site_apps.kogas.src.controllers.event_controller import on_monthly_usage_select_impl
    ...
    def on_drag_stop(self, *args, **kwargs):
        from site_apps.kogas.src.controllers.event_controller import on_drag_stop_impl
    ...
    def on_drag_start(self, *args, **kwargs):
        from site_apps.kogas.src.controllers.event_controller import on_drag_start_impl
        return on_drag_start_impl(self, *args, **kwargs)
        
    def on_resize_start(self, *args, **kwargs):
        from site_apps.kogas.src.controllers.event_controller import on_resize_start_impl
        return on_resize_start_impl(self, *args, **kwargs)
        
    def on_mouse_motion(self, *args, **kwargs):
        from site_apps.kogas.src.controllers.event_controller import on_mouse_motion_impl
    ...
    def setup_daily_usage_tab(self, *args, **kwargs):
        from site_apps.kogas.src.views.daily_usage_view import setup_daily_usage_tab_impl
        return setup_daily_usage_tab_impl(self, *args, **kwargs)

    def on_recent_record_click(self, *args, **kwargs):
        from site_apps.kogas.src.controllers.event_controller import on_recent_record_click_impl
    ...
    def _on_daily_usage_select(self, *args, **kwargs):
        from site_apps.kogas.src.controllers.event_controller import _on_daily_usage_select_impl
    ...
    def export_budget_estimation(self):
        ...
        try:
            from site_apps.kogas.src.utils.export_helper import export_budget_estimation_to_excel
    ...
    def on_budget_tree_select(self, *args, **kwargs):
        from site_apps.kogas.src.controllers.event_controller import on_budget_tree_select_impl
    ...
    def _on_daily_usage_resize(self, *args, **kwargs):
        from site_apps.kogas.src.controllers.event_controller import _on_daily_usage_resize_impl
    ...
    def _on_main_window_resize(self, *args, **kwargs):
        from site_apps.kogas.src.controllers.event_controller import _on_main_window_resize_impl
    ...
    def on_daily_usage_tree_select(self, *args, **kwargs):
        from site_apps.kogas.src.controllers.event_controller import on_daily_usage_tree_select_impl
    ...
    def format_entry_with_commas(self, *args, **kwargs):
        from site_apps.kogas.src.utils.helpers import format_entry_with_commas_impl
    ...
    def sync_worker_times(self, *args, **kwargs):
        from site_apps.kogas.src.models.worker_model import sync_worker_times_impl
    ...
    def export_daily_work_report(self, *args, **kwargs):
        if "export" in "export_daily_work_report" or "excel" in "export_daily_work_report":
            from site_apps.kogas.src.services.excel_exporter import export_daily_work_report_impl
        else:
            from site_apps.kogas.src.services.data_loader import export_daily_work_report_impl
        return export_daily_work_report_impl(self, *args, **kwargs)

    def export_central_daily_work_report(self, *args, **kwargs):
        from site_apps.kogas.src.services.excel_exporter import export_central_daily_work_report_impl
    ...
    def update_daily_usage_view(self, *args, **kwargs):
        from site_apps.kogas.src.views.daily_usage_view import update_daily_usage_view_impl
    ...
    def _calculate_ot_from_worktime(self, *args, **kwargs):
        from site_apps.kogas.src.models.worker_model import _calculate_ot_from_worktime_impl
    ...
    def _is_consumable_material(self, *args, **kwargs):
        from site_apps.kogas.src.models.material_model import _is_consumable_material_impl
    ...
    def export_weekly_report(self):
        ...
        def do_export():
            ...
            for date_val in sorted_dates:
                ...
                ws.cell(row=row_idx, column=2, value="가산~가평 현장").alignment = center_align
        ...
        def do_export():
            try:
                ...
                try:
                    ...
                    from site_apps.kogas.src.tagged_ndt_writer import write_all_tagged_sections
    ...
    def on_tab_drag_start(self, *args, **kwargs):
        from site_apps.kogas.src.controllers.event_controller import on_tab_drag_start_impl
        return on_tab_drag_start_impl(self, *args, **kwargs)

    def on_tab_drag(self, *args, **kwargs):
        from site_apps.kogas.src.controllers.event_controller import on_tab_drag_impl
        return on_tab_drag_impl(self, *args, **kwargs)

    def normalize_site_name(self, *args, **kwargs):
        from site_apps.kogas.src.utils.helpers import normalize_site_name_impl
        return normalize_site_name_impl(self, *args, **kwargs)

    def on_tab_drag_end(self, *args, **kwargs):
        from site_apps.kogas.src.controllers.event_controller import on_tab_drag_end_impl
        return on_tab_drag_end_impl(self, *args, **kwargs)
    
    def on_tab_changed(self, *args, **kwargs):
        from site_apps.kogas.src.controllers.event_controller import on_tab_changed_impl
    ...
    def calculate_ot_amount(self, *args, **kwargs):
        from site_apps.kogas.src.models.worker_model import calculate_ot_amount_impl
        return calculate_ot_amount_impl(self, *args, **kwargs)

    def _parse_ot_hours(self, *args, **kwargs):
        from site_apps.kogas.src.models.worker_model import _parse_ot_hours_impl
        return _parse_ot_hours_impl(self, *args, **kwargs)

    def _calculate_split_ot_hours(self, *args, **kwargs):
        from site_apps.kogas.src.models.worker_model import _calculate_split_ot_hours_impl
    ...
    def load_tab_config(self):
        ...
        try:
            ...
            if os.path.exists(self.config_path):
                ...
                from site_apps.kogas.src.views.components import VehicleInspectionWidget
    ...
    def on_closing(self, *args, **kwargs):
        from site_apps.kogas.src.controllers.event_controller import on_closing_impl
