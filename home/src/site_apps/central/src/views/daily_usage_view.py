...
from site_apps.central.src.utils.helpers import MARKER_PATTERN
import pandas as pd
...
def setup_daily_usage_tab_impl(self):
    ...
    def _calculate_ndt_fee():
        try:
            from site_apps.central.src.ndt_billing_tab import MATERIAL_COST, LABOR_COST
    ...
    self.cb_daily_equip._allow_multi = True
