...
class MaterialManager:
    def __init__(self, root):
        ...
        self.style.configure("Treeview", font=('Malgun Gothic', 12), rowheight=30)
    ...
    def setup_daily_usage_tab(self):
        ...
        self.daily_detail_text = tk.Text(detail_frame, wrap='word', width=35, background='#fdfdfd', font=('Pretendard', 14))
