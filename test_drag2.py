...
print("BEFORE DRAG:")
print(app.defects[0])
print("Side patches before:", len(app.ax_side.patches))

app.on_motion(MockEvent(5.0, 15.0, app.ax_side))

print("AFTER DRAG (z=15):")
print(app.defects[0])
print("Side patches after:", len(app.ax_side.patches))
