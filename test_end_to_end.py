...
template = None
for f in os.listdir(r'c:\Users\jjch2\Desktop\PMI\home\data'):
    if '기성' in f or '기본' in f:
        template = os.path.join(r'c:\Users\jjch2\Desktop\PMI\home\data', f)
        break

save_path = r'c:\Users\jjch2\Desktop\PMI\test_paut_output.xlsx'
