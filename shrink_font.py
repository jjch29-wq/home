    ...
    try:
        ...
        for sheet_name in wb.sheetnames:
            ...
            if cell.value:
                ...
                new_size = (current_font.size - 2) if current_font.size else 9
                ...
                print(f"[{file_path}] Changed G183 font size in sheet '{sheet_name}' from {current_font.size} to {new_size}. Content: {cell.value}")
                changed = True
